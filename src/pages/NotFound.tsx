  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-mystic-blue via-ancient-stone to-mystic-blue flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-ancient-stone/90 rounded-2xl p-8 text-center border border-ethereal-gold/30 backdrop-blur-md shadow-xl">
        ...
        <p className="text-muted-foreground mb-8 font-citizen text-lg leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            asChild
            className="bg-gradient-to-r from-verdant-glyph to-luminous-azure hover:from-verdant-glyph/90 hover:to-luminous-azure/90 text-foreground font-semibold px-6 py-3 rounded-lg transition-all duration-300 font-citizen shadow-lg hover:shadow-verdant-glyph/30"
          >
