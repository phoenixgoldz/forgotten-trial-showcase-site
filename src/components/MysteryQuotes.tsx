...
const MysteryQuotes = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-black/90 via-ancient-stone/80 to-black/90 relative overflow-hidden no-horizontal-scroll">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`transition-opacity duration-500 text-fixed-position ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="mb-8">
              <Quote className="w-16 h-16 text-ethereal-gold/60 mx-auto mb-6 animate-pulse" />
            </div>
            
            <blockquote className="font-cinzel text-2xl md:text-3xl lg:text-4xl font-light text-white mb-8 leading-relaxed italic text-center text-fixed-position" style={{ textShadow: '2px 2px 6px rgba(0,0,0,0.9)' }}>
              "{quote.text}"
            </blockquote>
            
            <div className="flex items-center justify-center space-x-4 mb-8">
              <div className="h-px w-12 bg-gradient-to-r from-transparent to-ethereal-gold"></div>
              <cite className="text-ethereal-gold font-medium not-italic text-center font-citizen text-fixed-position" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.8)' }}>{quote.author}</cite>
