              ...
              if (item.external) {
                return (
                  <button
                    ...
                    className={`flex items-center space-x-1 px-3 py-2 rounded-lg transition-all duration-200 font-citizen text-sm font-medium hover:text-ethereal-gold hover:bg-ethereal-gold/10 text-gray-100`}
                ...
                if (item.external) {
                  return (
                    <button
                      key={item.name}
                      onClick={() => handleNavClick(item.path, item.external)}
                      className="flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-200 font-citizen text-sm font-medium text-left hover:text-ethereal-gold hover:bg-ethereal-gold/10 text-gray-100"
                    >
                      <Icon className="w-4 h-4" />
                      <span>{item.name}</span>
                      <span className="text-xs" aria-hidden="true">↗</span>
